...
function getSummonerID(callback){
	...
	request.open('GET','https://na.api.pvp.net/api/lol/na/v1.4/summoner/by-name/' + name + '?api_key=749936b4-f094-4f04-a2e6-dd8caeb9299b');
...
function getSummonerStats(callback, id){
	...
	request.open('GET','https://na.api.pvp.net/api/lol/na/v1.3/stats/by-summoner/' + id + '/summary?api_key=749936b4-f094-4f04-a2e6-dd8caeb9299b');
